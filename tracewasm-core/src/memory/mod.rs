...
pub trait Memory {
    ...
    fn read_u8(&self, offset: usize) -> Result<u8, TraceWasmError> {
    ...
    fn write_u8(&mut self, offset: usize, data: u8) -> Result<(), TraceWasmError> {
        let buf: [u8; 1] = [data; 1];
    ...
    fn read_u16(&self, offset: usize) -> Result<u16, TraceWasmError> {
    ...
    fn write_u16(&mut self, offset: usize, data: u16) -> Result<(), TraceWasmError> {
    ...
    fn read_u32(&self, offset: usize) -> Result<u32, TraceWasmError> {
    ...
    fn write_u32(&mut self, offset: usize, data: u32) -> Result<(), TraceWasmError> {
    ...
    fn read_u64(&self, offset: usize) -> Result<u64, TraceWasmError> {
    ...
    fn write_u64(&mut self, offset: usize, data: u64) -> Result<(), TraceWasmError> {
    ...
    fn read_f32(&self, offset: usize) -> Result<f32, TraceWasmError> {
        let mut buf: [u8; 4] = [0; 4];
        self.read(offset, &mut buf)?;
    ...
    /// (no NaN canonicalization). Errors if the access is out of bounds.
    fn write_f32(&mut self, offset: usize, data: f32) -> Result<(), TraceWasmError> {
    ...
    /// (no NaN canonicalization). Errors if the access is out of bounds.
    fn read_f64(&self, offset: usize) -> Result<f64, TraceWasmError> {
        let mut buf: [u8; 8] = [0; 8];
        self.read(offset, &mut buf)?;
    ...
    /// (no NaN canonicalization). Errors if the access is out of bounds.
    fn write_f64(&mut self, offset: usize, data: f64) -> Result<(), TraceWasmError> {
        let buf = data.to_bits().to_le_bytes();
        self.write(offset, &buf)?;
